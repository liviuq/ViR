...
const searchQuery = urlParameters.get('string');

function getAndDisplayCardsForSearch()
{
    let cards = '';
    fetch(`https://vira3.herokuapp.com/api/card/search.php?string=${searchQuery}`)
    .then((res) => res.json())
    .then((data) => {
